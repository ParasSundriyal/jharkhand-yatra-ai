...
const Marketplace = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 42,
      image: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/22/d0/b3/95/single-bungalow.jpg?w=900&h=500&s=1",
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 15,
      image: "https://images.news18.com/ibnlive/uploads/2022/04/sarhul-16490081494x3.jpg",
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 31,
      image: "https://i0.wp.com/iasnext.com/wp-content/uploads/2023/07/Betla-National-Park-Jharkhand.jpg",
    ...
    },
    {
      ...
      rating: 4.8,
      reviews: 27,
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQb3IaBnbsFNsiKhglcY3Xpk2hjsTOQl1_XoA&s",
